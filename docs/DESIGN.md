...
Status: **M0 (design + asset pipeline)**. No app code yet. This document is the spec that M1+ build against.
...
| Window manager | own, small (`react-rnd` for drag/resize) | we need full visual control |
